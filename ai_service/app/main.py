...
# CORS middleware with explicit local origin support
allowed_origins = os.getenv("ALLOWED_ORIGINS", "http://127.0.0.1:5000,http://localhost:5000,http://127.0.0.1:5173,http://localhost:5173").split(",")
